...
#pragma omp single
    ...
    spbla_Matrix invaddr = create_spbla_transpose(ms["a"]);
    cout << "\tPts Edges:\n";
    print_matrix(invaddr, &id2node);
    // cout << "\tAddr Edges:\n";
    // print_matrix(ms["a"], &id2node);
    // cout << "\tCopy Edges:\n";
    // print_matrix(ms["c"], &id2node);
    // cout << "\tStore Edges:\n";
    // print_matrix(ms["s"], &id2node);
    // cout << "\tLoad Edges:\n";
    // print_matrix(ms["l"], &id2node);
